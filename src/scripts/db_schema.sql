...
--
-- Client: localhost
-- Généré le: Sam 19 Avril 2014 à 14:59
...
(5, 'BMDeveloppement', 'benoit.minard@gmail.com');
...
CREATE TABLE IF NOT EXISTS `delivery` (
  ...
  `distribution_round_archive_id` int(10) unsigned NOT NULL,
  ...
  KEY `distribution_round_cost_id` (`distribution_round_archive_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
INSERT INTO `delivery` (`id`, `distribution_round_id`, `distribution_round_archive_id`, `point_of_sale_id`, `date`, `price`) VALUES
(1, 1, 1, 2, '2014-04-22 10:06:55', 11.10),
(2, 1, 1, 2, '2014-04-09 10:06:55', 11.10),
(3, 1, 1, 2, '2014-04-11 10:06:55', 15.10),
(4, 1, 2, 2, '2014-04-11 10:06:55', 5.10),
(5, 2, 2, 2, '2014-04-01 10:06:55', 17.60);
...
--
-- Structure de la table `distribution_round_archive`
--

CREATE TABLE IF NOT EXISTS `distribution_round_archive` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `distribution_round_id` int(10) unsigned NOT NULL,
  `date` datetime NOT NULL,
...
--
-- Contenu de la table `distribution_round_archive`
--

INSERT INTO `distribution_round_archive` (`id`, `distribution_round_id`, `date`, `value`) VALUES
(1, 1, '2014-04-17 00:00:00', 14.9),
(2, 2, '2014-04-23 00:00:00', 9.87);
...
(3, 2, 2, 1, 3, '2013-04-13 11:50:00', 1.26, 1.44, 0.21, 14, 0),
(4, 2, 2, 1, 3, '2013-04-13 11:50:00', 1.26, 1.44, 0.21, 14, 0),
(5, 2, 2, 1, 3, '2013-04-02 11:50:00', 1.55, 2.44, 0.09, 14, 0),
(6, 2, 2, 1, 3, '2013-04-30 11:50:00', 1.55, 2.44, 0.09, 14, 0),
(7, 2, 2, 1, 3, '2013-04-18 11:50:00', 5.32, 1.44, 0.99, 14, 0);
...
(6, 4, 'Barbes Tour Eiffel', 1.02, 0.21, 10);
...
(1, 'mycompany', 'mail@mycompany.com', 1, '00:20:13'),
...
ALTER TABLE `delivery`
  ADD CONSTRAINT `delivery_ibfk_3` FOREIGN KEY (`distribution_round_archive_id`) REFERENCES `distribution_round_archive` (`id`),
...
--
-- Contraintes pour la table `distribution_round_archive`
--
ALTER TABLE `distribution_round_archive`
  ADD CONSTRAINT `distribution_round_archive_ibfk_1` FOREIGN KEY (`distribution_round_id`) REFERENCES `distribution_round` (`id`);
